...
`,Fe=()=>{const{collectionTypes:t,singleTypes:a,isLoading:o}=(0,$.bP)(),{guidedTourState:s,isGuidedTourVisible:u,isSkipped:y}=(0,l.useGuidedTour)(),j=!A(s)&&u&&!y,{push:x}=(0,O.useHistory)(),M=i=>{i.preventDefault(),x("/plugins/content-type-builder/content-types/create-content-type")},p=(0,e.useMemo)(()=>{const i=Ve=>Ve.filter($e=>$e.isDisplayed);return i(t).length>1||i(a).length>0},[t,a]);return o?e.createElement(l.LoadingIndicatorPage,null):e.createElement(F.Layout,null,e.createElement(f.FormattedMessage,{id:"HomePage.helmet.title",defaultMessage:"Homepage"},i=>e.createElement(D.Helmet,{title:i[0]})),e.createElement(W.Main,null,e.createElement(Oe,null,e.createElement("img",{alt:"","aria-hidden":!0,src:V})),e.createElement(c.Box,{padding:10},e.createElement(g.Grid,null,e.createElement(g.GridItem,{col:8,s:12},e.createElement(Me,{onCreateCT:M,hasCreatedContentType:p}))),e.createElement(g.Grid,{gap:6},e.createElement(g.GridItem,{col:8,s:12},j?e.createElement(ee,null):e.createElement(De,null)),e.createElement(g.GridItem,{col:4,s:12},e.createElement(Ce,null))))))},We=(0,e.memo)(Fe)},42462:(L,T,n)=>{L.exports=n.p+"fb376b132d18bf4522ca.png"}}]);
